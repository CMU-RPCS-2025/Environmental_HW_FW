# Title: CircuitPython library for dealing with MQ135 gas sensor
"""CircuitPython library for dealing with MQ135 gas sensor
...
class MQ135(object):
    """ Class for dealing with MQ135 Gas Sensors """
    ...
    def get_resistance(self):
        """Returns the resistance of the sensor in kOhms // -1 if no value got in pin"""
...
def mq135lib_example():
    ...
    mq135 = MQ135(board.A0)  # analog PIN A0
